...
/*zhuangxiaojian, C8680, Add for support flash controled by gpio {*/
#ifdef ORIGINAL_VERSION
#else
#define MSM_CAMERA_FLASH_SRC_GPIO (0x00000001<<6)
#endif
/*} zhuangxiaojian, C8680, Add for support flash controled by gpio*/
...
/*zhuangxiaojian, C8680, Add for support flash controlled by gpio {*/
#ifdef ORIGINAL_VERSION
#else
struct msm_camera_sensor_flash_gpio {
	uint32_t off;
	uint32_t low;
	uint32_t high;
	int (*set_flash_type)(uint32_t type);
};
#endif
/*} zhuangxiaojian, C8680, Add for support flash controlled by gpio*/
...
struct msm_camera_sensor_flash_src {
	...
	union {
		...
		/*zhuangxiaojian, C8680, control flash by gpio {*/
		struct msm_camera_sensor_flash_gpio gpio_src;
		/*} zhuangxiaojian, C8680, control flash by gpio*/
