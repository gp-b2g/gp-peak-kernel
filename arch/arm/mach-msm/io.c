...
//	MSM_CHIP_DEVICE(QGIC_CPU, MSM8625),
...
#endif
	{
        ...
        {
                .virtual = (unsigned long) MSM_QGIC_DIST_BASE,
                .pfn     = __phys_to_pfn(MSM8625_QGIC_DIST_PHYS),
                .length  = MSM8625_QGIC_DIST_SIZE,
                .type    = MT_DEVICE_STRONGLY_ORDERED,
        },
        {
                .virtual = (unsigned long) MSM_QGIC_CPU_BASE,
                .pfn     = __phys_to_pfn(MSM8625_QGIC_CPU_PHYS),
                .length  = MSM8625_QGIC_CPU_SIZE,
                .type    = MT_DEVICE_STRONGLY_ORDERED,
        },
};
