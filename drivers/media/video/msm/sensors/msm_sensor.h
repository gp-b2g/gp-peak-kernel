...
//zxj ++
struct msm_sensor_af_move_params_t;
//zxj --
...
struct msm_sensor_fn_t {
	...
	#else
	#ifdef CONFIG_OV8825
	int32_t (*sensor_focus_config)(struct msm_sensor_ctrl_t *, void __user *);
	int32_t (*sensor_af_init)(struct msm_sensor_ctrl_t *, struct msm_actuator_set_info_t *);
	int32_t (*sensor_set_default_focus)(struct msm_sensor_ctrl_t * ,struct msm_actuator_move_params_t *);
	int32_t (*sensor_move_focus)(struct msm_sensor_ctrl_t *, struct msm_actuator_move_params_t *);
	#endif

	#ifdef CONFIG_S5K3H2Y
	void (*get_calibration_data_from_eeprom)(struct msm_sensor_ctrl_t *s_ctrl,uint16_t idx, char *data);
	#endif
	#endif
	//zxj --
};
