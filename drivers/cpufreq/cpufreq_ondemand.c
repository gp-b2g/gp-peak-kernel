...
//The dbs_refresh_callback is work on specific CPU. So it is ok if it is preemptible.
static void dbs_refresh_callback(struct work_struct *unused)
{
	...
	/*FP:add the cpu_add_remove_lock to prevent the dbs get the wrong cpu id cpu_policy_rwsem, when the mpdecision call the cpufreq_add_dev to up/down cpu*/
