...
static int __init mipi_cmd_nt35510_alaska_wvga_pt_init(void)
{
	int ret;

	if (msm_fb_detect_client("mipi_cmd_nt35510_alaska_wvga"))
		return 0;
...
//	pinfo.is_3d_panel = FB_TYPE_3D_PANEL;
	...
	pinfo.mipi.dlane_swap = 0x01;//must set this, otherwise, boe lcd can't be on
	pinfo.mipi.tx_eot_append = 0x01; /* append EOT at the endz*/
...
module_init(mipi_cmd_nt35510_alaska_wvga_pt_init);
