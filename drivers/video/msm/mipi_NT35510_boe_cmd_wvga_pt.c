...
static int __init mipi_cmd_nt35510_boe_wvga_pt_init(void)
{
	int ret;
	...
	ret = mipi_nt35510_boe_device_register(&pinfo, MIPI_DSI_PRIM,
...
module_init(mipi_cmd_nt35510_boe_wvga_pt_init);
