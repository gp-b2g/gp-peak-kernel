...
static int __init mipi_cmd_otm8009a_wvga_pt_init(void)
{
	int ret;

	if (msm_fb_detect_client("mipi_cmd_otm8009a_wvga"))
		return 0;
	...
	ret = mipi_otm8009a_device_register(&pinfo, MIPI_DSI_PRIM,
...
module_init(mipi_cmd_otm8009a_wvga_pt_init);
