...
#define BAM250E_USE_EARLYSUSPEND	1
#define BAM250E_USE_SUSPEND			1

#if BAM250E_USE_EARLYSUSPEND
...
#define BMA2X2_RANGE_SET		BMA2X2_RANGE_8G  /* +/- 8G */
#define BMA2X2_BW_SET			BMA2X2_BW_125HZ /* 125HZ  */
		...
		const struct i2c_device_id *id)
{
	...
	case BMA250E_CHIP_ID:
		...
		bma250_chip_id = BMA250E_TYPE;
		printk(KERN_INFO "cellon_gsh bma250_chip_id=%d\n", bma250_chip_id);
		break;
...
//gsh add start
bool  bma2x2_sensor_id(void)
{
    if (bma250_chip_id==BMA250E_TYPE){
            return true;
    }
    else{
            return false;
...
EXPORT_SYMBOL(bma2x2_sensor_id);
//gsh add end
...
#define bma2x2_shutdown		NULL

#endif /* BAM250E_USE_SUSPEND */
